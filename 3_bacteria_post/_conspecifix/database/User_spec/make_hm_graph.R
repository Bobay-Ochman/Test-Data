png('/stor/work/Ochman/brian/examples/conExample3/_conspecifix/database/User_spec/gno1.png' ,width = 6,
  height    = 6,
  units     = "in",
  res       = 200)
par(mfrow=c(1,1))
tab = read.table('/stor/work/Ochman/brian/examples/conExample3/_conspecifix/database/User_spec/graph.txt',h=T)
