...
tab=read.table('/stor/work/Ochman/brian/examples/conExample3/_conspecifix/database/User_spec/kmeans.txt')
listOfValues= tab$V3
...
png('/stor/work/Ochman/brian/examples/conExample3/_conspecifix/database/User_spec/kmeans.png' ,width = 6,
  height    = 6,
  units     = "in",
  res       = 200)
...
write(strainsForRemoval,ncol=1,file='/stor/work/Ochman/brian/examples/conExample3/_conspecifix/database/User_spec/for_removal.txt')
